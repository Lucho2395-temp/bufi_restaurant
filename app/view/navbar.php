...
// Restar las fechas y obtener el resultado como un número entero
    $diferenciaEnSegundos = abs($timestampFecha1 - $timestampFecha2);

// Convertir la diferencia de tiempo a días (1 día = 86400 segundos)
    $diferenciaEnDias = $diferenciaEnSegundos / 86400;
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-auto ml-2">
                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Licencia Válida hasta  <?= $_SESSION['lic'] ?></div>
                        </div>
