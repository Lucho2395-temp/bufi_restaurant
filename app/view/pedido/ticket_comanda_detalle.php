...
//nombre del mesero
$mesero = $detalle_comanda[0]->persona_nombre;
...
foreach ($detalle_comanda as $de){
    if($de->id_grupo != 2){
        $printer->text($de->comanda_detalle_cantidad . "  " .$de->producto_nombre. "  "."(".$detalle_comanda[0]->comanda_detalle_despacho.")" .$de->comanda_detalle_observacion . "\n");
    }
}
