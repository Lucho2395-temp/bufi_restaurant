                                    ...
                                    foreach ($pedidos as $al){
                                        ...
                                        <tr <?= $stylee?>>
                                            ...
                                            <td style="text-align: left">
                                                <a type="button" title="Ver Pedido" class="btn btn-sm btn-primary" style="color: white" href="<?= _SERVER_ . 'index.php?c=Pedido&a=detalle_pedido_ver&id_mesa='. $al->id_mesa . '&id_comanda=' .$al->id_comanda;?>" ><i class="fa fa-eye ver_detalle"></i></a>
                                            </td>
