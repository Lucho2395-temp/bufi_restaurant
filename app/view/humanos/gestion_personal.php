                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                ...
                                <select class="form-control" name="persona_nacionalidad" id="persona_nacionalidad">
                                    ...
                                    <option selected>PERUANA</option>
                        ...
                        <div class="card-body">
                            <form class="form-row" method="post" action="<?= _SERVER_ . 'RHumanos/gestion_personal';?>">
                                <div class="form-group col-md-4">
                                    <input name="parametro" type="text" value="<?= $parametro;?>" class="form-control" id="parametro" placeholder="Nombre, Apellido Paterno o Documento de Identidad">
                                </div>
                                <div class="form-group col-md-4" >
