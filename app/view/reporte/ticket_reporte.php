...
foreach ($cajas_totales as $ct) {
    ...
    $ingresos_totales_delivery = $reporte_ingresos_delivery + $reporte_ingresos_tarjeta_delivery + $reporte_ingresos_transferencia_delivery;
    ...
    $printer->text('APERTURA DE CAJA' . '                   S/ ' . $caja . "\n");
    $printer->text('INGRESOS DE CAJA CHICA' . '             S/ ' . $reporte_ingresos_movi . "\n");
    $printer->text("------------------------------------------------\n");
    $printer->text('VENTAS EN SALON' . '                     S/ ' . $ingresos_totales_salon . "\n");
    $printer->text('PAGOS EFECTIVO' . '                      S/ ' . $ingresos . "\n");
    $printer->text('PAGOS TARJETA' . '                       S/ ' . $reporte_ingresos_tarjeta . "\n");
    $printer->text('PAGOS TRANSFERENCIA' . '                 S/ ' . $reporte_ingresos_transferencia . "\n");
    $printer->text("------------------------------------------------\n");
    $printer->text('VENTAS DELIVERY' . '                     S/ ' . $ingresos_totales_delivery . "\n");
    $printer->text('PAGOS EFECTIVO' . '                      S/ ' . $reporte_ingresos_delivery . "\n");
    $printer->text('PAGOS TARJETA' . '                       S/ ' . $reporte_ingresos_tarjeta_delivery . "\n");
    $printer->text('PAGOS TRANSFERENCIA' . '                 S/ ' . $reporte_ingresos_transferencia_delivery . "\n");
    $printer->text("------------------------------------------------\n");
    $printer->text('EGRESOS' . '                             S/ ' . $egresos_totales . "\n");
    $printer->text('SALIDAS CAJA CHICA' . '                  S/ ' . $reporte_egresos_movi . "\n");
    $printer->text("------------------------------------------------\n");
