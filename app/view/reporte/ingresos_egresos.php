            ...
            <div class="row">
                                    ...
                                    <table class="table table-borderless " id="" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            if($datos){
                                                ...
                                                $caja = $this->reporte->sumar_caja_(date("Y-m-d",$i),$id_caja_numero);
                                                $reporte_ingresos_movi = $this->reporte->listar_datos_ingresos_caja_(date("Y-m-d",$i),$id_caja_numero);
                                                ...
                                                $reporte_egresos_movi = $this->reporte->listar_datos_egresos_(date("Y-m-d",$i),$id_caja_numero);
                                                ...
                                                $diferencia = $reporte_ingresos_movi + $ingresos + $reporte_ingresos_tarjeta + $reporte_ingresos_transferencia - $reporte_egresos_movi - $reporte_orden_pedido;

                                                $ingresos_total = $ingresos_total + $caja+ $reporte_ingresos_movi + $ingresos;
                                                $egresos_total = $reporte_egresos_movi + $reporte_orden_pedido;
                                                $egresos_total_ = $egresos_total_ + $reporte_egresos_movi;
                                                $ingresos_total_ = $ingresos_total_ + $reporte_ingresos_movi + $ingresos + $reporte_ingresos_tarjeta + $reporte_ingresos_transferencia;
                                                $fecha = date("d-m-Y",$i);
                                                ?>
                                                <tr>
                                                    <td><?= $fecha;?></td>
                ...
                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-6">
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <div class="table-responsive">
                                <p>Ingresos: <?= $ingresos_total_; ?></p>
                                <p style="border-bottom: 1px solid red">Egresos: <?= $egresos_total_; ?></p>
                                <p>Utilidad: <?= $ingresos_total_ - $egresos_total_; ?></p>
                            </div>
                        </div>
                    </div>
                </div>
