        ...
        try{
            ...
            if($ok_data) {
                ...
                if($id_ne == 1){
					...
					$listar_recurso_existente = $this->insumos->listar_recurso_existe($recurso_nombre);
					if($listar_recurso_existente){
						$model->id_recurso = $listar_recurso_existente->id_recurso;
					}else{
						$model = new Recursos();
						$model->id_categoria = $id_categoria;
                ...
                if($model->id_recurso!=0){
                    ...
                    if(empty($_POST['recurso_sede_merma'])){
                        $model->recurso_sede_cantidad = $_POST['recurso_sede_cantidad'];
                        $model->recurso_sede_stock = $_POST['recurso_sede_stock'];
                    }else{
                        $model->recurso_sede_cantidad = $_POST['recurso_sede_peso_final'];
                        $model->recurso_sede_stock = $_POST['recurso_sede_peso_final'];
                    }
