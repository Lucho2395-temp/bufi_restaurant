...
CREATE TABLE `almacenes` (
  ...
  `almacen_nombre` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `almacen_capacidad` int NOT NULL,
...
CREATE TABLE `asistencia` (
  ...
  `asistencia_valor` int NOT NULL,
  `asistencia_horas` int NOT NULL DEFAULT '0',
  `asistencia_observacion` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `asistencia_tipo` tinyint DEFAULT NULL COMMENT '0 entrada, 1 salida',
  `asistencia_estado` tinyint NOT NULL,
  `asistencia_proyectada` tinyint NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `asistencia_fecha` (
  `id_asistencia_fecha` int NOT NULL,
  `fecha` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `caja_numero` (
  `id_caja_numero` int NOT NULL,
  `caja_numero_nombre` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
(2, 'Caja Número 2', '2021-07-23 00:00:00', 0);
...
CREATE TABLE `categorias` (
  ...
  `categoria_nombre` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
(1, 'Bebidas Calientes', '2025-08-26 02:13:29', 1),
(2, 'Frozen', '2025-08-26 02:13:29', 1),
(3, 'Bebidas Frías', '2025-08-26 02:13:29', 1),
(4, 'Desayunos', '2025-08-26 02:13:29', 1),
(5, 'Sándwich', '2025-08-26 02:13:29', 1),
(6, 'Salados', '2025-08-26 02:13:29', 1),
(7, 'Postres', '2025-08-26 02:13:29', 1);
...
CREATE TABLE `ciudad` (
  ...
  `ciudad_nombre` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
CREATE TABLE `clientes` (
  ...
  `cliente_nombre` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cliente_numero` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cliente_correo` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cliente_direccion` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cliente_direccion_2` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(1, 2, NULL, 'Cliente General', '11111111', NULL, 'Sin dirección', NULL, NULL, '2025-08-22 03:36:20', 1),
(2, 4, 'SALAZAR BARTRA LUIS ANTONIO', '', '10711064325', '', '-', '', '', '2025-08-28 16:03:07', 1),
...
(11, 2, '', '  Adriana Rainero', '74194536', '', '', '', '961935967', '2025-09-05 17:10:19', 1),
(12, 2, '', '  Estrella Soplin', '73771438', '', '', '', '920692306', '2025-09-05 17:11:02', 1),
(13, 2, '', '  Matías Casado', '71228163', '', '', '', '963343991', '2025-09-05 17:11:34', 1),
(14, 2, '', '  Josias Solignac', '73107513', '', '', '', '929175198', '2025-09-05 17:12:11', 1),
(15, 2, '', '  Maria Paz', '61015467', '', '', '', '955643591', '2025-09-05 17:12:49', 1),
(16, 2, '', '  Mayalen Saavedra', '60923976', '', '', '', '925403116', '2025-09-05 17:13:32', 1),
(17, 2, '', '  Alejandro Diaz', '72690362', '', '', '', '940609665', '2025-09-05 17:14:15', 1),
(18, 2, '', '  Marco Antonio Gonzales', '71925124', '', '', '', '956324116', '2025-09-05 17:14:48', 1),
(19, 2, '', '  Ivana Panduro', '74690648', '', '', '', '966072999', '2025-09-05 17:15:28', 1),
(20, 2, '', '  Prince Padilla', '61277443', '', '', '', '901427898', '2025-09-05 17:16:01', 1);
...
CREATE TABLE `comanda` (
  ...
  `comanda_nombre_delivery` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `comanda_direccion_delivery` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `comanda_telefono_delivery` varchar(15) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `comanda_cantidad_personas` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `comanda_correlativo` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `comanda_total` decimal(10,2) NOT NULL,
  `comanda_fecha_registro` datetime NOT NULL,
  `comanda_estado` tinyint NOT NULL,
  `comanda_codigo` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `comanda_detalle` (
  `id_comanda_detalle` int NOT NULL,
  `id_comanda` int NOT NULL,
  `id_producto` int NOT NULL,
  `comanda_detalle_precio` decimal(10,2) NOT NULL,
  `comanda_detalle_cantidad` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `comanda_detalle_despacho` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `comanda_detalle_total` decimal(10,2) NOT NULL,
  `comanda_detalle_observacion` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `comanda_detalle_fecha_registro` datetime NOT NULL,
  `comanda_detalle_fecha_eliminacion` datetime DEFAULT NULL,
  `comanda_detalle_estado` tinyint NOT NULL,
  `comanda_detalle_estado_venta` tinyint NOT NULL DEFAULT '0',
  `comanda_detalle_hora_entrega` time DEFAULT NULL,
  `comanda_detalle_usuario` int DEFAULT NULL,
  `id_usuario_eli` int DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `conversiones` (
  ...
  `id_recurso_sede` int NOT NULL,
  `conversion_cantidad` decimal(10,2) NOT NULL,
  `conversion_unidad_medida` int NOT NULL,
  `conversion_fecha_registro` datetime NOT NULL,
  `conversion_estado` tinyint NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `detalle_compra` (
  ...
  `detalle_compra_tipo_moneda` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
...
CREATE TABLE `detalle_recetas` (
  ...
  `id_recursos_sede` int NOT NULL,
  `detalle_receta_unidad_medida` int DEFAULT NULL,
  `detalle_receta_cantidad` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `detalle_receta_precio` decimal(10,2) NOT NULL,
  `detalle_receta_estado` tinyint NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `documentos` (
  ...
  `documento_nombre` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
CREATE TABLE `empresa` (
  ...
  `empresa_nombrecomercial` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `empresa_descrpcion` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `empresa_ruc` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `empresa_domiciliofiscal` varchar(250) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `empresa_pais` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `empresa_departamento` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `empresa_provincia` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `empresa_distrito` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `empresa_ubigeo` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `empresa_telefono1` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `empresa_telefono2` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `empresa_celular1` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `empresa_celular2` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
...
CREATE TABLE `envio_resumen` (
  ...
  `envio_resumen_serie` varchar(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `envio_resumen_correlativo` varchar(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `envio_resumen_nombreXML` varchar(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `envio_resumen_nombreCDR` varchar(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `envio_resumen_estado` tinyint NOT NULL DEFAULT '0',
  `envio_resumen_estadosunat` varchar(2000) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `envio_resumen_estadosunat_consulta` varchar(2000) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `envio_resumen_ticket` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `feriados` (
  ...
  `feriado_motivo` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `grupos` (
  ...
  `grupo_nombre` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `grupo_ticketera` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
...
CREATE TABLE `igv` (
  `id_igv` int NOT NULL,
  `igv_codigo` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `igv_codigoafectacion` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `igv_descripcion` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `igv_codigoInternacional` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `igv_nombre` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `igv_tipodeafectacion` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
CREATE TABLE `memorandum` (
  ...
  `id_persona` int NOT NULL,
  `memorandum_numero` int DEFAULT NULL,
  `memorandum_motivo` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `memorandum_otros` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `memorandum_fecha` date NOT NULL,
  `memorandum_descripcion` varchar(5000) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `id_usuario` int NOT NULL,
  `memorandum_fecha_creacion` datetime NOT NULL,
  `id_user_aprobacion` int DEFAULT NULL,
  `memoradum_fecha_aprobacion` datetime DEFAULT NULL,
  `memorandum_estado` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 3, 1, 'SANCIONES Y/O AMONESTACIONES', '', '2021-09-13', 'sancion por faltas sin justificacion', 2, '2021-09-13 09:52:33', 2, '2021-09-13 09:52:33', 1);
...
CREATE TABLE `mesas` (
  ...
  `id_sucursal` int NOT NULL,
  `mesa_nombre` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `mesa_capacidad` int NOT NULL,
  `mesa_estado` tinyint NOT NULL,
  `mesa_estado_atencion` int NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `movimientos` (
  ...
  `id_usuario` int NOT NULL,
  `id_sucursal` int NOT NULL,
  `movimiento_tipo` tinyint NOT NULL COMMENT '1 es entrada y 2 es salida',
  `egreso_descripcion` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `egreso_monto` decimal(10,2) NOT NULL,
  `egreso_fecha_registro` datetime NOT NULL,
  `egreso_estado` tinyint NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `negocios` (
  `id_negocio` int NOT NULL,
  `id_ciudad` int NOT NULL,
  `negocio_nombre` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `negocio_direccion` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `negocio_ruc` varchar(15) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `negocio_foto` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `negocio_telefono` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
CREATE TABLE `nota_venta` (
  ...
  `id_moneda` int NOT NULL,
  `nota_venta_tipo` varchar(10) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL COMMENT 'aca siempre 20, porque es nota de venta',
  `nota_venta_serie` varchar(10) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `nota_venta_correlativo` varchar(60) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  ...
  `nota_venta_observacion` varchar(500) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `nota_venta_cancelar` tinyint NOT NULL DEFAULT '0' COMMENT 'si esta 1 significa que fue cancelada',
  `nota_venta_estado` tinyint NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `nota_venta_detalle` (
  `id_nota_venta_detalle` int NOT NULL,
  `id_nota_venta` int NOT NULL,
  `id_comanda_detalle` int NOT NULL,
  ...
  `nota_venta_detalle_nombre_producto` varchar(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `obligacion_pagar` (
  ...
  `id_user_aprobacion` int DEFAULT NULL,
  `obligacion_clase` tinyint NOT NULL,
  `obligacion_codigo` int DEFAULT NULL,
  ...
  `obligacion_tipo` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `obligacion_concepto` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `obligacion_activo` tinyint(1) NOT NULL,
  `obligacion_moneda` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `obligacion_importe` float(10,2) DEFAULT NULL,
  `obligacion_id_persona` int DEFAULT NULL,
  `obligacion_documentacion` tinyint NOT NULL,
...
CREATE TABLE `obligacion_personal` (
  `id_obligacionper` int NOT NULL,
  `id_obligacion` int NOT NULL,
  `id_persona` int NOT NULL,
  `id_periodo` int NOT NULL,
  `obligacionper_dias_efectivos` float(10,2) NOT NULL,
  `obligacionper_dias_laborales` int NOT NULL,
  ...
  `obligacionper_banco` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `obligacionper_cuenta` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
...
(110, 20, 'Ticket productos', 'ticket_productos_', '', 0, 0, 1),
...
CREATE TABLE `orden_compra` (
  ...
  `id_aprobacion` int DEFAULT NULL,
  `id_proveedor` int NOT NULL,
  `id_sucursal` int NOT NULL,
  `id_tipo_pago` int DEFAULT NULL,
  `orden_compra_observacion` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `orden_compra_fecha_aprob` datetime DEFAULT NULL,
  `orden_compra_titulo` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `orden_compra_activo` int DEFAULT NULL,
  `orden_compra_numero` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `orden_compra_estado` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `orden_compra_fecha` datetime NOT NULL,
  `orden_compra_tipo_doc` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `orden_compra_numero_doc` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `orden_compra_doc_adjuntado` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `orden_compra_fecha_emision_doc` date DEFAULT NULL,
  `orden_compra_doc_cuotas` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `orden_compra_fecha_recibida` datetime DEFAULT NULL,
  `orden_compra_usuario_recibido` int NOT NULL,
  `orden_compra_codigo` varchar(40) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `pedidos_gratis` (
  `id_pedido_gratis` int NOT NULL,
  `id_mesa` int NOT NULL,
  `id_usuario` int NOT NULL,
  `pedido_gratis_numero` varchar(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `pedido_gratis_nombre` varchar(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `pedido_gratis_direccion` varchar(500) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `pedido_gratis_total` decimal(10,2) NOT NULL DEFAULT '0.00',
  `pedido_gratis_observacion` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `pedido_gratis_datetime` datetime DEFAULT NULL,
  `pedido_gratis_codigo` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `pedido_gratis_estado` tinyint NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `pedidos_gratis_detalles` (
  `id_pedido_gratis_detalle` int NOT NULL,
  `id_pedido_gratis` int NOT NULL,
  `id_comanda_detalle` int NOT NULL,
  `id_pedido_gratis_detalle_estado` tinyint NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `periodo_laboral` (
  ...
  `periodo_observa` varchar(250) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `periodo_estado` varchar(5) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `periodo_contrato` tinyint(1) DEFAULT NULL,
  `periodo_nro_contrato` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `id_user_creacion` int DEFAULT NULL,
  `id_user_aprobacion` int DEFAULT NULL,
  `periodo_fecha_creacion` date DEFAULT NULL,
  `periodo_hora_creacion` time DEFAULT NULL,
  `periodo_bono` float(10,2) DEFAULT NULL,
  `perioido_ruc_centro_estudio` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `periodo_nombre_centro_estudio` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `periodo_domicilio_centro_estudio` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `periodo_dni_representante` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `periodo_nombre_representante` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `periodo_ciclo` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `periodo_especialidad` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(166, 106, 'ticket_reporte', 1),
(167, 106, 'ticket_productos', 1),
(168, 100, 'ticket_productos', 1),
(169, 100, 'ticket_productos_', 1),
(170, 2, 'guardar_cierre_caja', 1),
(171, 39, 'cambiarestado_enviado', 1),
(174, 114, 'despachar_pedido_comanda', 1),
(175, 116, 'buscar_reporte_movimientos', 1);
...
CREATE TABLE `personas` (
  ...
  `persona_discapacidad` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `persona_job` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `persona_nacimiento` date DEFAULT NULL,
  `persona_sexo` char(2) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `persona_telefono` char(15) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `persona_telefono_2` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `persona_foto` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `persona_hijos` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `persona_departamento` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `persona_provincia` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `persona_distrito` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `persona_adicional` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `persona_afp` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `persona_cuspp` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  ...
  `persona_cv` varchar(300) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
...
CREATE TABLE `persona_turno` (
  ...
  `persona_estado_turno` tinyint NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 6, 4, '2021-09-01 16:31:54', 1),
(2, 8, 3, '2021-09-01 16:35:56', 1),
(3, 7, 3, '2021-09-01 16:38:05', 1),
(4, 3, 1, '2021-09-01 16:39:41', 1),
(5, 9, 1, '2021-09-01 16:41:17', 1),
(6, 4, 1, '2021-09-01 16:42:34', 1),
(7, 11, 1, '2021-09-01 16:43:44', 1),
(8, 10, 2, '2021-09-01 16:46:16', 1),
(9, 5, 2, '2021-09-01 16:51:45', 1),
(10, 12, 2, '2021-11-16 18:38:16', 1),
(11, 13, 2, '2021-11-17 16:49:25', 1),
(12, 14, 3, '2021-12-13 14:27:22', 1);
...
CREATE TABLE `productos` (
  ...
  `producto_nombre` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `producto_codigo_barra` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `producto_descripcion` varchar(300) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `producto_foto` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `producto_estado` tinyint(1) NOT NULL,
  `producto_fecha_registro` datetime NOT NULL,
  `producto_codigo` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 1, 2, 1, 1, 'Americano Classic', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '1'),
(2, 1, 2, 1, 1, 'Café Expresso', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '2'),
(3, 1, 2, 1, 1, 'Capuccino Asesino', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '3'),
(4, 1, 2, 1, 1, 'Infusiones', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '4'),
(5, 1, 2, 1, 2, 'Maracuya Pop', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '5'),
(6, 1, 2, 1, 2, 'Camu Power', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '6'),
(7, 1, 2, 1, 2, 'Arazá Wow', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '7'),
(8, 1, 2, 1, 2, 'Taperiboom', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '8'),
(9, 1, 2, 1, 2, 'Pink Punch', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '9'),
(10, 1, 2, 1, 2, 'Mango Ice', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '10'),
(11, 1, 2, 1, 2, 'Piña Splash', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '11'),
(12, 1, 2, 1, 3, 'Refresco maracuya', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '12'),
(13, 1, 2, 1, 3, 'Refresco camu camu', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '13'),
(14, 1, 2, 1, 3, 'Refresco araza ', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '14'),
(15, 1, 2, 1, 3, 'Refresco taperiba', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '15'),
(16, 1, 2, 1, 3, 'Refresco manzana', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '16'),
(17, 1, 2, 1, 3, 'Frappe oreo', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '17'),
(18, 1, 2, 1, 3, 'Frappe cafe ', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '18'),
(19, 1, 2, 1, 3, 'Frappe maracuya', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '19'),
(20, 1, 2, 1, 3, 'Frappe fresa', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '20'),
(21, 1, 2, 1, 3, 'Agua c/s gas ', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '21'),
(22, 1, 2, 1, 3, 'Gaseosa coca cola', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '22'),
(23, 1, 2, 1, 3, 'Gaseosa inca kola', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '23'),
(24, 1, 2, 1, 3, 'Te helado', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '24'),
(25, 1, 2, 1, 3, 'Refresco piña ', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '25'),
(26, 1, 2, 1, 3, 'Refresco mango', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '26'),
(27, 1, 2, 1, 3, 'Fresa con leche', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '27'),
(28, 1, 2, 1, 3, 'Jugo de papaya', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '28'),
(29, 1, 2, 1, 3, 'Surtido', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '29'),
(30, 1, 2, 1, 3, 'Malta', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '30'),
(31, 1, 1, 1, 4, 'Desayuno americano', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '31'),
(32, 1, 1, 1, 4, 'Desayuno omelette', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '32'),
(33, 1, 1, 1, 4, 'Desayuno criollo', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '33'),
(34, 1, 1, 1, 5, 'Pan con pollo', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '34'),
(35, 1, 1, 1, 5, 'Avocado Sandwich', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '35'),
(36, 1, 1, 1, 5, 'Triple Power', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '36'),
(37, 1, 1, 1, 5, 'Triple Sunny', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '37'),
(38, 1, 1, 1, 5, 'Atún Frame', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '38'),
(39, 1, 1, 1, 5, 'Cheese Sandwich', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '39'),
(40, 1, 1, 1, 5, 'Club 2D', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '40'),
(41, 1, 1, 1, 6, 'Pizza Pop', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '41'),
(42, 1, 1, 1, 6, 'Tequeños', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '42'),
(43, 1, 1, 1, 6, 'Empa Chick', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '43'),
(44, 1, 1, 1, 6, 'Empa Beef', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '44'),
(45, 1, 1, 1, 6, 'Juane ', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '45'),
(46, 1, 1, 1, 6, 'Tamal', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '46'),
(47, 1, 1, 1, 6, 'Humita ', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '47'),
(48, 1, 1, 1, 6, 'Broaster Crunch', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '48'),
(49, 1, 1, 1, 6, 'Alitas bbq ', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '49'),
(50, 1, 1, 1, 6, 'Alitas Acevi-Crush', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '50'),
(51, 1, 1, 1, 6, 'Chaufa amazónico ', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '51'),
(52, 1, 1, 1, 6, 'Canoitas amazónicos', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '52'),
(53, 1, 1, 1, 6, 'Nuggets', '', '', 'media/producto/default.png', 1, '2025-08-27 00:00:00', '53'),
(54, 1, 1, 1, 6, 'Hamburguesa', '', '', 'media/producto/default.png', 0, '2025-08-27 00:00:00', '54'),
(55, 1, 1, 1, 6, 'Salchipapa', '', '', 'media/producto/default.png', 0, '2025-08-27 00:00:00', '55'),
(56, 1, 1, 16, 6, 'Chaufa', NULL, '', 'media/producto/default.png', 1, '2025-08-30 14:01:51', '1756580511.8072'),
(57, 1, 2, 16, 3, 'Chocolate frío', NULL, '', 'media/producto/default.png', 1, '2025-08-30 14:08:07', '1756580887.7292'),
(58, 1, 2, 16, 2, 'Camu camu Ice', NULL, '', 'media/producto/default.png', 1, '2025-08-30 14:44:07', '1756583047.5515'),
(59, 1, 2, 16, 8, 'Jugo de Piña', NULL, '', 'media/producto/default.png', 1, '2025-09-04 11:20:22', '1757002822.9529'),
(60, 1, 2, 16, 8, 'Jugo Surtido', NULL, '', 'media/producto/default.png', 1, '2025-09-04 11:21:23', '1757002883.96'),
(61, 1, 2, 16, 8, 'Jugo Surtido Especial', NULL, '', 'media/producto/default.png', 1, '2025-09-04 11:21:56', '1757002916.8927'),
(62, 1, 2, 16, 8, 'Malta con Huevo', NULL, '', 'media/producto/default.png', 1, '2025-09-04 11:22:27', '1757002947.6753'),
(63, 1, 2, 16, 8, 'Jugo de Fresa', NULL, '', 'media/producto/default.png', 1, '2025-09-04 11:23:07', '1757002987.6905'),
(64, 1, 2, 16, 8, 'Jugo de Fresa con Leche', NULL, '', 'media/producto/default.png', 1, '2025-09-04 11:23:41', '1757003021.2303'),
(65, 1, 2, 16, 8, 'Papaya con Limon', NULL, '', 'media/producto/default.png', 1, '2025-09-04 11:24:18', '1757003058.0042'),
(66, 1, 2, 16, 8, 'Platano con Leche', NULL, '', 'media/producto/default.png', 1, '2025-09-04 11:24:49', '1757003089.7077'),
(67, 1, 1, 16, 6, 'Hambur bur', NULL, '', 'media/producto/default.png', 1, '2025-09-04 11:32:32', '1757003552.9567'),
(68, 1, 1, 16, 6, 'Salchipapa', NULL, '', 'media/producto/default.png', 1, '2025-09-04 11:33:25', '1757003605.9492'),
(69, 1, 1, 16, 6, 'Salchipapa', NULL, '', 'media/producto/default.png', 0, '2025-09-04 11:34:06', '1757003646.1142');
...
CREATE TABLE `producto_familia` (
  `id_producto_familia` int NOT NULL,
  `producto_familia_nombre` varchar(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `producto_familia_fecha_registro` datetime NOT NULL,
  `producto_familia_estado` tinyint NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 'Bebidas Calientes', '2025-08-27 22:30:56', 1),
(2, 'Frozen', '2025-08-27 22:32:54', 1),
(3, 'Bebidas Frías', '2025-08-27 22:33:03', 1),
(4, 'Desayunos', '2025-08-27 22:33:11', 1),
(5, 'Sándwich', '2025-08-27 22:33:18', 1),
(6, 'Salados', '2025-08-27 22:33:27', 1),
(7, 'Postres', '2025-08-27 22:33:35', 1),
(8, 'Jugos', '2025-09-04 11:15:53', 1);
...
CREATE TABLE `producto_precio` (
  ...
  `producto_precio_codigoafectacion` char(2) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT '20',
...
CREATE TABLE `proveedor` (
  ...
  `id_negocio` int NOT NULL,
  `id_tipodocumento` int NOT NULL,
  `proveedor_nombre` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `proveedor_ruc` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `proveedor_direccion` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `proveedor_nombre_contacto` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `proveedor_cargo_persona` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `proveedor_numero` varchar(9) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `proveedor_estado` int NOT NULL,
...
CREATE TABLE `recetas` (
  ...
  `receta_estado` tinyint NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 1, 'Producto General', '2025-08-27 21:25:47', 1);
...
CREATE TABLE `recursos` (
  ...
  `id_categoria` int NOT NULL,
  `recurso_nombre` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
CREATE TABLE `recursos_movimientos` (
  `id_recurso_movimiento` int NOT NULL,
  `id_recurso_sede` int NOT NULL,
  `recurso_movimientos_cantidad` decimal(10,2) NOT NULL,
  `recurso_movimientos_fecha` datetime NOT NULL,
  `recurso_movimientos_estado` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `recursos_sede` (
  ...
  `recurso_sede_merma` decimal(10,2) DEFAULT '0.00',
...
CREATE TABLE `registro_asistencias` (
  ...
  `asistencia_comentarios` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `reporte_movimiento` (
  ...
  `reporte_movimiento_tipo` int NOT NULL COMMENT '1=Entrada 2=Salida',
  `id_usuario` int NOT NULL,
  `reporte_movimiento_fecha` datetime NOT NULL,
  `reporte_movimiento_estado` int NOT NULL,
  `reporte_movimiento_mt` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `reporte_movimiento_detalle` (
  `id_reporte_movimiento_detalle` int NOT NULL,
  `id_reporte_movimiento` int NOT NULL,
  `id_recurso_sede` int NOT NULL,
  `reporte_movimiento_detalle_cantidad` decimal(10,2) NOT NULL,
  `reporte_movimiento_detalle_estado` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `reservas` (
  ...
  `id_mesa` int NOT NULL,
  `reserva_nombre` varchar(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `reserva_cantidad` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `serie` (
  ...
  `tipocomp` char(2) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `serie` varchar(8) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
...
CREATE TABLE `sub_recetas` (
  ...
  `sub_receta_estado` tinyint NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `sucursal` (
  ...
  `id_ciudad` int NOT NULL,
  `id_negocio` int NOT NULL,
  `sucursal_nombre` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `sucursal_direccion` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `sucursal_ruc` varchar(15) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `sucursal_foto` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `sucursal_telefono` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
CREATE TABLE `tipoadjuntos` (
  `id_adjunto` int NOT NULL,
  `adjunto_nombre` varchar(150) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
  `adjunto_ext` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `tipocargo` (
  `id_cargo` int NOT NULL,
  `id_departamento` int NOT NULL,
  `cargo_nombre` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `tipocontrato` (
  `id_contrato` int NOT NULL,
  `contrato_nombre` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `tipodepartamento` (
  `id_departamento` int NOT NULL,
  `departamento_nombre` varchar(150) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `tiposede` (
  `id_sede` int NOT NULL,
  `sede_nombre` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `tipo_afectacion` (
  ...
  `codigo_afectacion` char(4) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `nombre_afectacion` char(3) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `tipo_afectacion` char(3) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL
...
CREATE TABLE `tipo_ncreditos` (
  ...
  `tipo_nota_descripcion` varchar(250) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
...
CREATE TABLE `tipo_pago` (
  `id_tipo_pago` int NOT NULL,
  `tipo_pago_nombre` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
CREATE TABLE `turno` (
  `id_turno` int NOT NULL,
  `turno_nombre` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `turno_hora_entrada` time NOT NULL,
  `turno_hora_tolerancia` time NOT NULL,
  `turno_hora_salida` time NOT NULL,
  `turno_estado` tinyint NOT NULL,
  `turno_fecha_registro` datetime NOT NULL,
  `turno_usuario_registro` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `unidad_medida` (
  ...
  `medida_nombre` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci DEFAULT NULL,
...
CREATE TABLE `usuarios_negocio` (
  `id_usuario_negocio` int NOT NULL,
  `id_negocio` int NOT NULL,
  `id_usuario` int NOT NULL,
...
(9, 4, 16, 5, '2025-08-28 16:30:20', 1),
(10, 4, 17, 4, '2025-08-28 16:31:37', 1),
(11, 4, 18, 4, '2025-08-28 16:31:45', 1),
(12, 4, 19, 4, '2025-08-28 16:31:53', 1),
(13, 4, 15, 5, '2025-08-28 16:32:10', 1);
...
CREATE TABLE `ventas_anulados` (
  ...
  `venta_anulado_serie` varchar(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `venta_anulado_correlativo` int NOT NULL,
  `venta_anulacion_ticket` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `venta_anulado_rutaXML` varchar(1000) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `venta_anulado_rutaCDR` varchar(1000) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `venta_anulado_estado_sunat` varchar(1000) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `id_venta` int NOT NULL,
  `id_user` int NOT NULL,
...
CREATE TABLE `ventas_cuotas` (
  ...
  `id_tipo_pago` int NOT NULL,
  `venta_cuota_numero` varchar(30) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `ventas_detalle_pagos` (
  `id_venta_detalle_pago` int NOT NULL,
  `id_venta` int NOT NULL,
  `id_tipo_pago` int NOT NULL,
...
ALTER TABLE `reporte_movimiento_detalle`
  ...
  ADD KEY `id_reporte_movimiento` (`id_reporte_movimiento`,`id_recurso_sede`),
  ADD KEY `id_recurso_sede` (`id_recurso_sede`);
